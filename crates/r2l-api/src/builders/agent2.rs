...
use r2l_core::{env::ActionSpaceType, on_policy::algorithm2::Agent2};
...
impl<Params, HookBuilder, Backend> OnPolicyAgentBuilder2<Params, HookBuilder, Backend> {
    pub fn with_candle(
        self,
        device: Device,
    ) -> OnPolicyAgentBuilder2<Params, HookBuilder, CandleBackend2> {
