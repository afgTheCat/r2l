...
#[derive(Debug, Module)]
pub struct DiagGaussianDistribution2<B: Backend, N: Module<B>> {
    mu_net: N,
    log_std: Param<Tensor<B, 2>>,
}

impl<B: Backend> DiagGaussianDistribution2<B, Mlp<B>> {
...
impl<B: Backend, N: Network<B>> Actor for DiagGaussianDistribution2<B, N> {
...
impl<B: Backend, N: Module<B> + ModuleDisplay> ToSafetensors for DiagGaussianDistribution2<B, N> {
...
impl<B: Backend, N: Network<B>> Policy for DiagGaussianDistribution2<B, N> {
