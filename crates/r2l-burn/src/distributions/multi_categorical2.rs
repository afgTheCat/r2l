...
#[derive(Debug, Module)]
pub struct MultiCategoricalDistribution2<B: Backend, N: Module<B>> {
    logits: N,
    backend: PhantomData<B>,
    nvec: Vec<usize>,
}

impl<B: Backend> MultiCategoricalDistribution2<B, Mlp<B>> {
...
impl<B: Backend, N: Network<B>> Actor for MultiCategoricalDistribution2<B, N> {
...
impl<B: Backend, N: Module<B> + ModuleDisplay> ToSafetensors
    for MultiCategoricalDistribution2<B, N>
{
...
impl<B: Backend, N: Network<B>> Policy for MultiCategoricalDistribution2<B, N> {
