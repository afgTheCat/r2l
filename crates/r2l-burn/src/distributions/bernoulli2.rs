...
#[derive(Debug, Module)]
pub struct MultiBernoulliDistribution2<B: Backend, N: Module<B>> {
    logits: N,
    backend: PhantomData<B>,
    action_size: usize,
}

impl<B: Backend> MultiBernoulliDistribution2<B, Mlp<B>> {
...
impl<B: Backend, N: Network<B>> Actor for MultiBernoulliDistribution2<B, N> {
...
impl<B: Backend, N: Module<B> + ModuleDisplay> ToSafetensors for MultiBernoulliDistribution2<B, N> {
...
impl<B: Backend, N: Network<B>> Policy for MultiBernoulliDistribution2<B, N> {
