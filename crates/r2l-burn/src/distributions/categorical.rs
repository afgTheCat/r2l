...
#[derive(Debug, Module)]
pub struct CategoricalDistribution<B: Backend, N: Module<B>> {
    logits: N,
    _b: PhantomData<B>,
}
...
impl<B: Backend, N: Module<B> + ModuleDisplay> ToSafetensors for CategoricalDistribution<B, N> {
...
impl<B: Backend, N: Network<B>> Policy for CategoricalDistribution<B, N> {
    fn log_probs(
        &self,
