...
pub struct VPG2<Module: OnPolicyLearningModule> {
    /// VPG hyperparameters.
...
impl<Module: OnPolicyLearningModule> VPG2<Module> {
...
impl<M: OnPolicyLearningModule> Agent2 for VPG2<M> {
