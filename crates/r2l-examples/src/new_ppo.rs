...
impl PPOHooksTrait5<LearningModuleKind> for PPOHook {
    fn before_learning_hook<B: r2l_core::sampler5::buffer::TrajectoryContainer<Tensor = Tensor>>(
        &mut self,
        _agent: &mut r2l_agents::candle_agents::ppo5::CandlePPOCore5<LearningModuleKind>,
        buffers: &[B],
    ...
    fn rollout_hook<B: r2l_core::sampler5::buffer::TrajectoryContainer<Tensor = Tensor>>(
        &mut self,
        _buffers: &[B],
        agent: &mut r2l_agents::candle_agents::ppo5::CandlePPOCore5<LearningModuleKind>,
    ) -> candle_core::Result<HookResult> {
